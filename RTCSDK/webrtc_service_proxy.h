...
namespace vi {
	BEGIN_WEAK_PROXY_MAP(WebRTCService)
		...
		WEAK_PROXY_METHOD2(int32_t, remoteVolume, int64_t, const std::string&)
		WEAK_PROXY_METHOD2(int32_t, localVolume, int64_t, const std::string&)
		WEAK_PROXY_METHOD2(bool, isAudioMuted, int64_t, const std::string&)
		WEAK_PROXY_METHOD2(bool, isVideoMuted, int64_t, const std::string&)
		WEAK_PROXY_METHOD2(bool, muteAudio, int64_t, const std::string&)
		WEAK_PROXY_METHOD2(bool, muteVideo, int64_t, const std::string&)
		WEAK_PROXY_METHOD2(bool, unmuteAudio, int64_t, const std::string&)
		WEAK_PROXY_METHOD2(bool, unmuteVideo, int64_t, const std::string&)
		WEAK_PROXY_METHOD2(std::string, getBitrate, int64_t, const std::string&)
